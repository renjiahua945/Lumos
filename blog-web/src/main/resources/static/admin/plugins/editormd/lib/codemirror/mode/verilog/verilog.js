...
CodeMirror.defineMode("verilog", function(config, parserConfig) {
  ...
  var keywords = words(
    ...
    "bins binsof bit break buf bufif0 bufif1 byte case casex casez cell chandle checker class clocking cmos configs " +
  ...
  */
  ...
  var blockKeywords = words(
    "case checker class clocking configs function generate interface module package" +
